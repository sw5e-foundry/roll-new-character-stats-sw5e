...
import sw5e_ActorHelper from "../helpers/sw5e-actor-helper.js";
...
export class ConfigureActor extends FormApplication {
    ...
    async getData() {
        ...
        // let sw5e_actor_helper = null;      // For future use
    ...
    async _updateObject(event, formData) {
        ...
        switch (game.system.id) {
            case "sw5e":
                let sw5e_actor_helper = new sw5e_ActorHelper(actor);
                sw5e_actor_helper._Update(formData);
                break;
            case "pf1":
