...
export default class sw5e_ActorHelper extends base_ActorHelper {
    ...
    async _Update(data) {
        ...
        // _final_score_display includes Racial Mod - will revisit this when sw5e implements race items (see pf1).
